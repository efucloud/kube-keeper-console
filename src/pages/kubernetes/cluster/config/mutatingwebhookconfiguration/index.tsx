...
const IndexDashboard: React.FC = () => {
  ...
  const {
    ...
    cluster,
    address: 'apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations',
      ...
      render: (_, record) => {
        const nodes = [
          <a
            key="edit"
            onClick={() => {
              window.location.href = normalizeKubernetesPath(`/kubernetes/cluster/${cluster}/config/mutatingwebhookconfigurations/${record?.metadata?.name}/update`);
            }}
          >
          ...
          <Space separator={<Divider orientation="vertical" />}>
            ...
            <Access accessible={true} key={'create'}>
              <Button
                ...
                key="create"
                onClick={() => {
                  window.location.href = normalizeKubernetesPath(`/kubernetes/cluster/${cluster}/config/mutatingwebhookconfigurations/create/text`)
                }}
              >
