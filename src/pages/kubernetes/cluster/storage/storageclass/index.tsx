...
const IndexDashboard: React.FC = () => {
  ...
  const {
    ...
    cluster,
    address: `apis/${resourceGroup.groupVersion}/storageclasses`,
          ...
          <Space separator={<Divider orientation="vertical" />}>
            ...
            <Access accessible={true} key={'create'}>
              <Button
                ...
                key="create"
                onClick={() => {
                  window.location.href = normalizeKubernetesPath(`/kubernetes/cluster/${cluster}/storage/storageclass/create/text`);
                }}
              >
