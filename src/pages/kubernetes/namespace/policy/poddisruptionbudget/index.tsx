...
const IndexDashboard: React.FC = () => {
  ...
  const columns: ProColumns<IPodDisruptionBudget>[] = [
        ...
        return (
          <>
            <a
              onClick={() => {
                window.open(
                  appendKubernetesViewQuery(`/kubernetes/namespace/policy/poddisruptionbudgets`, { cluster: cluster, namespace: entity?.metadata?.namespace }),
                );
              }}
            >
    ...
    },
    {
      ...
      render: (dom, entity) => {
        return <a onClick={() => { window.location.href = appendKubernetesViewQuery(`/kubernetes/namespace/policy/poddisruptionbudgets/${entity?.metadata?.name}/update`, { cluster: cluster, namespace: entity?.metadata?.namespace }); }}>{entity?.metadata?.name}</a>;
      },
    },
    {
          ...
          <Space separator={<Divider orientation="vertical" />}>
            ...
            <Access accessible={true} key={'create'}>
              <Button
                ...
                key="create"
                onClick={() => {
                  window.location.href = appendKubernetesViewQuery(`/kubernetes/namespace/policy/poddisruptionbudgets/create/text`, { cluster: cluster, namespace: namespace });
                }}
              >
