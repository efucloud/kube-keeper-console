        ...
        return (
          <>
            <a
              onClick={() => {
                window.open(
                  appendKubernetesViewQuery(`/kubernetes/namespace/config/limitranges`, { cluster: cluster, namespace: entity?.metadata?.namespace }),
                );
              }}
            >
      ...
      render: (dom, entity) => {
        return (
          <>
            <a
              onClick={() => {
                window.location.href = appendKubernetesViewQuery(`/kubernetes/namespace/config/limitranges/${entity?.metadata?.name}/update`, { cluster: cluster, namespace: entity?.metadata?.namespace });
              }}
            >
      ...
      render: (_, record) => {
        const nodes = [
          <a
            key="edit"
            onClick={() => {
              window.location.href = appendKubernetesViewQuery(`/kubernetes/namespace/config/limitranges/${record?.metadata?.name}/update`, { cluster: cluster, namespace: record?.metadata?.namespace });
            }}
          >
              ...
              <Button
                ...
                onClick={() => {
                  window.location.href = appendKubernetesViewQuery(namespace
                    ? appendKubernetesViewQuery(`/kubernetes/namespace/config/limitranges/create/text`, { cluster: cluster, namespace: namespace })
                    : appendKubernetesViewQuery(`/kubernetes/cluster/config/limitranges/create/text`, { cluster: cluster }));
                }}
              >
