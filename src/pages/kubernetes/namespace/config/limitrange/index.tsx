import { CloseCircleOutlined, EditOutlined, EyeInvisibleOutlined, EyeOutlined, InsertRowBelowOutlined, MoreOutlined, UnorderedListOutlined } from '@ant-design/icons';
        ...
        return (
          <>
            <a
              onClick={() => {
                window.open(
                  normalizeKubernetesPath(`/kubernetes/cluster/${cluster}/namespace/${entity?.metadata?.namespace}/config/limitranges`),
                );
              }}
            >
      ...
      render: (dom, entity) => {
        return (
          <>
            <a
              onClick={() => {
                window.location.pathname = normalizeKubernetesPath(`/kubernetes/cluster/${cluster}/namespace/${entity?.metadata?.namespace}/config/limitranges/${entity?.metadata?.name}/update`);
              }}
            >
      ...
      render: (_, record) => {
        const nodes = [
          <a
            key="edit"
            onClick={() => {
              window.location.href = normalizeKubernetesPath(`/kubernetes/cluster/${cluster}/namespace/${record?.metadata?.namespace}/config/limitranges/${record?.metadata?.name}/update`);
            }}
          >
